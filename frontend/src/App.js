        ...
        <Router>
          <div className="dashboard-wrapper">
            ...
            <Routes>
              ...
              <Route
                path="/user/:id/groups/:groupId/"
                element={<GroupsDashboard />}
              />
              <Route path="/user/:id/expenses" element={<Expenses />} />
              <Route
                path="/user/:id/expenses/category/:categoryId"
                element={<Expenses />}
              />
              <Route
                path="/user/:id/groups/:groupId/expenses"
                element={<Expenses />}
              />
              <Route
                path="/user/:id/groups/:groupId/expenses/category/:categoryId"
                element={<Expenses />}
              />
