...
export function Expenses() {
  ...
  const groupFilteredData = !params.groupId ? data : data.filter(item => item.groupId.toString() === params.groupId)
      ...
      <div className="expenses-list-wrapper">
        <ul className="expenses-component">
          <li className="expenses-component-list">
            <ExpensesList userId={params.id} loading={loading} data={categoryFilteredData} error={error}/>
          </li>
        </ul>
      </div>
    </div>
