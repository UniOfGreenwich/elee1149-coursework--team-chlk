      ...
      <div className="recent-expenses-row">
        <div className="expense-details">
          ...
          <div className={"expense-titles" + (props.category === settlementCategoryId ? "-settlement" : "")}>
              <p className={"expense-name" + (props.category === settlementCategoryId ? "-settlement" : "")}>{`${props.expenseName} ${(props.category === settlementCategoryId && props.split.find(item => item.userId === props.currentUser) ? " (to you)" : "")}`}</p>
              { props.category !== settlementCategoryId ?
